...
const presentationSlides = [
    { title: 'Onboarding Progressif Automatisé', subtitle: 'Mairie de Charenton-le-Pont — Direction du Numérique', content: '<div class="slide-hero"><div class="hero-stat"><span class="stat-label">Étudiant</span><span class="stat-value">Slim Touabti</span></div><div class="hero-stat"><span class="stat-label">Période</span><span class="stat-value">Stage 2A | Jan-Fév 2026</span></div><div class="hero-stat"><span class="stat-label">Lieu</span><span class="stat-value">Mairie de Charenton</span></div><p style="margin-top:30px;font-size:1rem;color:#4d9fff"><em>Un projet de transformation digitale en conditions réelles de production</em></p></div>', color: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)' },
    { title: 'État Initial du Processus', subtitle: 'Le problème : 100 % manuel', content: '<div class="slide-context"><div class="context-box"><strong>🏢 Mairie de Charenton-le-Pont</strong><p>Commune de ~30 000 habitants (Val-de-Marne)<br>150+ nouveaux agents intégrés chaque année<br>Infrastructure IT : AD / Exchange / Partages / Intranet</p></div><div class="context-box" style="background:rgba(239,68,68,0.08);border-left:4px solid #ef4444"><strong>⚠️ Le défi du technicien</strong><p>Un technicien devait retrouver les bons documents, rédiger un mail, envoyer la charte informatique, les guides d\'utilisation des outils, les accès intranet… <strong>Le tout à la main, un agent après l\'autre.</strong><br><br><strong style="color:#ef4444">🔴 Problème critique :</strong> <em>La charte informatique a une valeur juridique</em>. Si un agent ne l\'a pas reçue et commet une faute numérique, la DSI peut être mise en cause. <strong>La traçabilité de cet envoi est donc critique.</strong></p></div></div>', color: 'linear-gradient(135deg, #2d1b3d 0%, #1a0a2e 100%)' },
    { title: 'Problématique', subtitle: '', content: '<div class="slide-problem-statement"><p style="font-size:1.2rem;line-height:1.8;color:#e0e0e0;margin:0"><strong style="font-size:1.4rem;color:#4d9fff">Comment automatiser l\'accompagnement numérique des nouveaux arrivants, pour réduire la charge du support, tout en garantissant que chaque agent reçoive la charte informatique de façon traçable, dès sa première connexion ?</strong></p></div>', color: 'linear-gradient(135deg, #1f1a4e 0%, #1a0a2e 100%)' },
    { title: 'Objectif', subtitle: 'Un scénario en trois temps', content: '<div class="slide-objective"><div class="objective-phase-row"><div><strong style="color:#4d9fff;font-size:1.1rem">📅 J-0 — Le jour de la première connexion</strong><p>L\'agent reçoit un mail de bienvenue <strong>de la part du Maire Hervé Gicquel</strong> avec ses accès de base, les outils essentiels et <strong>la charte informatique en pièce jointe</strong>.</p></div><div class="objective-benefits"><span>✓ Meilleure image du Maire</span><span>✓ Premier contact personnel</span><span>✓ Traçabilité légale</span></div></div><div class="objective-phase-row"><div><strong style="color:#4d9fff;font-size:1.1rem">📅 J+3 — Trois jours après</strong><p>Un second mail centré sur les outils métiers, l\'imprimante réseau, l\'intranet.</p></div><div class="objective-benefits"><span>✓ Productivité accélérée</span><span>✓ Réduction support</span><span>✓ Autonomie agent</span></div></div><div class="objective-phase-row"><div><strong style="color:#4d9fff;font-size:1.1rem">📅 J+7 — Une semaine après</strong><p>Un rappel ciblé sur les bonnes pratiques de cybersécurité.</p></div><div class="objective-benefits"><span>✓ Compliance IT</span><span>✓ Sécurité renforcée</span><span>✓ Risques limités</span></div></div><hr style="opacity:0.3;margin:20px 0"><p style="text-align:center;color:#51cf66;font-weight:600;margin:15px 0"><strong>✓ Tout ce scénario se déclenche automatiquement, sans aucune intervention humaine, quel que soit le volume de nouveaux arrivants.</strong></p></div>', color: 'linear-gradient(135deg, #1a2a4e 0%, #0f1529 100%)' },
    { title: "LA V1 - L'approche Active Directory", subtitle: "Stocker l'etat d'onboarding dans l'AD", content: `<div class="slide-ad-v1" style="display:flex;flex-direction:column;gap:16px"><div style="background:rgba(77,159,255,0.08);border-left:4px solid #4d9fff;border-radius:8px;padding:14px 18px"><strong style="color:#4d9fff">Idee de depart</strong><p style="margin-top:8px;color:#e0e0e0">Tout le SI repose sur l'Active Directory &mdash; autant l'utiliser pour stocker l'etat d'onboarding de chaque agent.</p></div><div style="background:rgba(255,255,255,0.04);border-radius:8px;padding:14px 18px"><strong style="color:#c0c0c0">Validation DSI</strong><p style="margin-top:8px;color:#e0e0e0">Pour garantir compatibilite et tracabilite, j'ai soumis une <a href="assets/Demande de validation %E2%80%93 Verification de l'utilisation des extensionAttribute dans l'AD-1 (1).pdf" target="_blank" style="color:#4d9fff;text-decoration:underline;font-weight:600">demande de validation technique</a> a la DSI pour verifier quel attribut etait libre. Mon choix : <strong>extensionAttribute2</strong> &mdash; attribut generique, non utilise dans notre environnement.</p></div><div style="background:rgba(255,255,255,0.04);border-radius:8px;padding:14px 18px"><strong style="color:#c0c0c0">Le mecanisme</strong><p style="margin-top:8px;color:#e0e0e0">Simple en apparence : si l'attribut est <strong>vide</strong> &rarr; le script envoie le mail J-0 et ecrit la valeur <code style="background:rgba(255,255,255,0.1);padding:1px 6px;border-radius:4px">Sent</code> pour marquer le compte.</p></div><div style="background:rgba(239,68,68,0.08);border-left:4px solid #ef4444;border-radius:8px;padding:12px 18px;display:flex;align-items:center;gap:12px"><span style="font-size:1.4rem">&#9888;</span><p style="color:#f87171;margin:0;font-weight:600">En apparence, c'est propre. Mais&hellip;</p></div></div>`, color: 'linear-gradient(135deg, #1e3a2e 0%, #0a1a10 100%)' },
    { title: 'Les Problèmes, Pivot Technique', subtitle: 'Deux blocages majeurs rencontrés', content: `<div class="slide-problems"><div class="problem-block"><strong>Problème 1 — Copie de compte</strong><p>Les techniciens créaient les nouveaux comptes en copiant un modèle, ce qui dupliquait tous les attributs, y compris <strong>extensionAttribute2</strong>. Résultat : un nouvel agent pouvait arriver déjà marqué 'Sent' et ne jamais recevoir ses mails d'onboarding.</p></div><div class="problem-block"><strong>Problème 2 — Droits d'écriture</strong><p>Un utilisateur standard ne peut pas modifier son propre objet dans AD. Pour que le script écrive dans <strong>extensionAttribute2</strong>, il aurait fallu déléguer des droits sur toute l'OU, ce qui augmente la surface d'attaque et va à l'encontre des bonnes pratiques de sécurité. Cette piste a donc été abandonnée.</p></div><div class="pivot-learned" style="margin-top:18px;color:#4d9fff"><em>Ces erreurs m'ont permis de pivoter vers une solution plus fiable et sécurisée.</em></div></div>`, color: 'linear-gradient(135deg, #2e1a1a 0%, #1a0a0a 100%)' },
    { title: 'LA V2 — LA SOLUTION ROBUSTE', subtitle: 'Deux changements architecturaux décisifs', content: '<div class="slide-v2-solution"><p style="font-size:1rem;color:#c0c0c0;margin-bottom:20px">Pour la V2, j\'ai repensé l\'architecture depuis ses fondations avec deux changements majeurs.</p><div class="v2-change-block" style="background:rgba(77,159,255,0.08);border-left:4px solid #4d9fff;border-radius:8px;padding:16px 20px;margin-bottom:18px"><strong style="color:#4d9fff;font-size:1.05rem">Premier changement : le <code>logonCount</code></strong><p style="margin-top:10px;color:#e0e0e0">Au lieu d\'un attribut personnalisé, j\'utilise l\'attribut système <code>logonCount</code>, qui compte le nombre de connexions réelles d\'un utilisateur. Cet attribut est <strong>non copiable</strong> — il repart toujours à zéro sur un nouveau compte. C\'est exactement ce que je cherchais.</p><p style="margin-top:10px;color:#e0e0e0">J\'ai fixé un seuil de détection à <strong>15 connexions maximum</strong> pour définir un "nouvel arrivant". Cela laisse une marge pour la préparation technique du poste avant l\'arrivée réelle de l\'agent, sans faux positifs.</p></div><div class="v2-change-block" style="background:rgba(39,201,63,0.08);border-left:4px solid #27c93f;border-radius:8px;padding:16px 20px"><strong style="color:#27c93f;font-size:1.05rem">Deuxième changement : le Registre Windows local</strong><p style="margin-top:10px;color:#e0e0e0">Au lieu de stocker l\'état dans l\'AD, je l\'écris dans la ruche <strong>HKCU</strong> — HKEY_CURRENT_USER — du registre Windows.</p><div style="margin-top:12px;display:flex;gap:18px;flex-wrap:wrap"><div style="background:rgba(255,255,255,0.05);border-radius:6px;padding:10px 14px;flex:1;min-width:180px"><span style="color:#27c93f;font-weight:700">① Zéro délégation</span><p style="color:#c0c0c0;margin-top:4px;font-size:0.92rem">L\'utilisateur a nativement les droits d\'écriture sur sa propre session.</p></div><div style="background:rgba(255,255,255,0.05);border-radius:6px;padding:10px 14px;flex:1;min-width:180px"><span style="color:#27c93f;font-weight:700">② Zéro dépendance réseau</span><p style="color:#c0c0c0;margin-top:4px;font-size:0.92rem">État local au poste et à la session — aucune dépendance réseau pour lire cet état.</p></div></div></div></div>', color: 'linear-gradient(135deg, #1a2e1a 0%, #0a1a0a 100%)' },
    { title: 'Le moteur du scenarио — Registre & AD', subtitle: 'StartDate, [adsisearcher] et le pilotage temporel', content: `<div class="slide-v2-engine" style="display:flex;flex-direction:column;gap:16px"><div style="background:rgba(77,159,255,0.08);border-left:4px solid #4d9fff;border-radius:8px;padding:16px 20px"><strong style="color:#4d9fff">Le pilotage temporel via le Registre</strong><p style="margin-top:10px;color:#e0e0e0">Le script stocke en registre une cle <code style="background:rgba(255,255,255,0.1);padding:1px 6px;border-radius:4px">StartDate</code> &mdash; la date de la premiere connexion detectee. A chaque ouverture de session suivante, il calcule l&rsquo;ecart entre cette date et le jour courant pour decider quel mail envoyer.</p><p style="margin-top:10px;color:#51cf66;font-weight:600">C&rsquo;est ce mecanisme qui pilote le scenario J0, J+3, J+7.</p></div><div style="background:rgba(39,201,63,0.08);border-left:4px solid #27c93f;border-radius:8px;padding:16px 20px"><strong style="color:#27c93f">Interroger l&rsquo;AD sans RSAT &mdash; <code style="background:rgba(255,255,255,0.08);padding:1px 6px;border-radius:4px">[adsisearcher]</code></strong><p style="margin-top:10px;color:#e0e0e0">Pour interroger l&rsquo;Active Directory, j&rsquo;utilise l&rsquo;accelerateur <code style="background:rgba(255,255,255,0.1);padding:1px 6px;border-radius:4px">[adsisearcher]</code>. Pourquoi ce choix ?</p><div style="margin-top:12px;display:flex;gap:14px;flex-wrap:wrap"><div style="background:rgba(255,255,255,0.05);border-radius:6px;padding:10px 14px;flex:1;min-width:160px"><span style="color:#27c93f;font-weight:700">Requetes LDAP directes</span><p style="color:#c0c0c0;margin-top:4px;font-size:0.92rem">Sans charger le module RSAT &mdash; non installe sur les postes utilisateurs.</p></div><div style="background:rgba(255,255,255,0.05);border-radius:6px;padding:10px 14px;flex:1;min-width:160px"><span style="color:#27c93f;font-weight:700">Plus leger, plus securise</span><p style="color:#c0c0c0;margin-top:4px;font-size:0.92rem">Moins de dependances, surface d&rsquo;attaque reduite, compatible poste standard.</p></div></div></div></div>`, color: 'linear-gradient(135deg, #1a1a2e 0%, #0a0a1a 100%)' },
    { title: 'Architecture Technique Finale', subtitle: 'Vue d\'ensemble du système', content: '<div class="slide-architecture"><div class="arch-diagram"><div class="arch-layer"><span class="layer-label">Déploiement</span><div class="layer-content">✓ GPO + Script PowerShell sur 50 postes administratifs</div></div><div class="arch-divider">↓</div><div class="arch-layer alt"><span class="layer-label">Détection</span><div class="layer-content">✓ logonCount &lt; 15 = nouveau compte détecté</div></div><div class="arch-divider">↓</div><div class="arch-layer"><span class="layer-label">Intégration</span><div class="layer-content">✓ AD + Exchange + Partages réseau + Imprimantes</div></div><div class="arch-divider">↓</div><div class="arch-layer alt"><span class="layer-label">Suivi Temporel</span><div class="layer-content">✓ Registre local (HKCU) + Jalons J0 / J3 / J7</div></div><div class="arch-divider">↓</div><div class="arch-layer"><span class="layer-label">Notification</span><div class="layer-content">✓ Emails SMTP via exchange.charenton.fr</div></div></div><div style="margin-top:18px;background:rgba(81,207,102,0.1);border-left:4px solid #51cf66;border-radius:8px;padding:14px 18px"><p style="color:#51cf66;font-weight:600;margin:0">Les resultats sont concrets : moins d&rsquo;oublis, moins de tickets support pour des demandes basiques, et surtout une tracabilite complete et automatique de la diffusion de la charte informatique pour chaque agent.</p></div></div>', color: 'linear-gradient(135deg, #1f1a2e 0%, #16213e 100%)' },
    { title: 'Phase 1 — J0 : Bienvenue', subtitle: 'Premier jour de l\'agent municipal', content: '<div class="slide-phase-detail"><div class="phase-what"><strong>🎯 Objectif</strong><p>Intégration totale du nouvel agent dans le système informatique</p></div><div class="phase-actions"><div class="action"><span class="action-icon">📋</span><div><strong>Création compte AD automatique</strong><p style="color:#b0bec5">UPN réglementaire, attribution OU par service via HashMap mappings</p></div></div><div class="action"><span class="action-icon">📧</span><div><strong>Provisioning boîte Exchange</strong><p style="color:#b0bec5">Alias multiples (prenom.nom + initiales civiles)</p></div></div><div class="action"><span class="action-icon">📨</span><div><strong>Email de bienvenue personnalisé</strong><p style="color:#b0bec5">Lien Intranet Mairie + instructions premier accès</p></div></div></div><p style="margin-top:12px;padding:12px;background:rgba(77,159,255,0.08);border-radius:8px;color:#4d9fff;font-size:0.9rem"><strong>⏱ Résultat : 6 heures vs 48h avant</strong></p></div>', color: 'linear-gradient(135deg, #1a2a3e 0%, #0f1529 100%)' },
    { title: 'Phase 2 — J+3 : Maîtrisez vos outils', subtitle: 'Premiers jours — Autonomie utilisateur', content: '<div class="slide-phase-detail"><div class="phase-what"><strong>🛠️ Objectif</strong><p>Rendre l\'agent autonome sur ses outils de travail quotidiens</p></div><div class="phase-actions"><div class="action"><span class="action-icon">🖨️</span><div><strong>Accès imprimantes réseau</strong><p style="color:#b0bec5">Configuration automatique via GPO + tutoriels intégrés</p></div></div><div class="action"><span class="action-icon">✍️</span><div><strong>Configuration signature mail</strong><p style="color:#b0bec5">Template standardisé Mairie, branding officiel appliqué</p></div></div><div class="action"><span class="action-icon">📖</span><div><strong>Accès Knowledge Base intranet</strong><p style="color:#b0bec5">Ressources KB + troubleshooting rapide + support</p></div></div></div><p style="margin-top:12px;padding:12px;background:rgba(77,159,255,0.08);border-radius:8px;color:#ff8833;font-size:0.9rem"><strong>B1.2 :</strong> Demande d\'assistance déléguée par automatisation</p></div>', color: 'linear-gradient(135deg, #2e1a1a 0%, #1a0a0a 100%)' },
    { title: 'Phase 3 — J+7 : Sécurité & Procédures', subtitle: 'Semaine de convergence — Conformité IT', content: '<div class="slide-phase-detail"><div class="phase-what"><strong>🔐 Objectif</strong><p>Sensibiliser aux politiques de sécurité IT et procédures administratives</p></div><div class="phase-actions"><div class="action"><span class="action-icon">🛡️</span><div><strong>Formation sécurité IT appliquée</strong><p style="color:#b0bec5">Mots de passe forts, phishing, conformité RGPD, bonnes pratiques</p></div></div><div class="action"><span class="action-icon">📅</span><div><strong>Gestion des congés et RH</strong><p style="color:#b0bec5">Portail Auto-Service RH Mairie, procédures calendrier</p></div></div><div class="action"><span class="action-icon">📞</span><div><strong>Contact support escalade</strong><p style="color:#b0bec5">Email support-dnum@charenton.fr pour incidents</p></div></div></div><p style="margin-top:12px;padding:12px;background:rgba(77,159,255,0.08);border-radius:8px;color:#51cf66;font-size:0.9rem"><strong>B2.6 :</strong> Sécuriser l\'infrastructure par sensibilisation utilisateur</p></div>', color: 'linear-gradient(135deg, #1a3a2e 0%, #0f1a15 100%)' },
    { title: 'Leçons Apprises', subtitle: 'Enseignements techniques et humains', content: '<div class="slide-lessons"><div class="lesson"><span class="lesson-num">1</span><div><strong>Validation technique = efficacité</strong><p>Soumettre architecture AVANT code = pivot technique découvert, gagné 2 semaines</p></div></div><div class="lesson"><span class="lesson-num">2</span><div><strong>Attributs immuables = fiabilité</strong><p>logonCount : impossible à modifier = audit-proof et ultra-fiable</p></div></div><div class="lesson"><span class="lesson-num">3</span><div><strong>GPO = scalabilité sans maintenance</strong><p>Déploiement automatique sur les postes, zéro intervention manuelle après mise en place</p></div></div><div class="lesson"><span class="lesson-num">4</span><div><strong>Voir l\'impact concret motive</strong><p>Passer de 48h à 6h pour intégrer un agent, c\'est visible, c\'est tangible — ca donne du sens au travail technique</p></div></div><div class="lesson"><span class="lesson-num">5</span><div><strong>Documenter les pièges = productivité future</strong><p>Playbook pour admins = évite à d\'autres de refaire les erreurs</p></div></div></div>', color: 'linear-gradient(135deg, #2e1a4e 0%, #1a0a2e 100%)' },
    { title: 'Compétences BTS SIO', subtitle: 'Validation complète du référentiel SISR', content: '<div class="slide-competences-final"><div class="comp-final"><h4 style="color:#27c93f">B1 — Bloc Assistance Informatique</h4><div class="comp-detail"><strong>B1.2 — Répondre aux incidents et demandes d\'assistance</strong><p>✓ Automatisation d\'un processus manuel de 18 étapes (demande-bloquante)</p></div><div class="comp-detail"><strong>B1.4 — Travailler en mode projet</strong><p>✓ Méthodologie itérative : audit → conception → pivot technique → développement → test → déploiement prod</p></div></div><div class="comp-final"><h4 style="color:#4d9fff">B2 — Bloc Infrastructure & Sécurité</h4><div class="comp-detail"><strong>B2.2 — Mettre en place une solution d\'infrastructure</strong><p>✓ Intégration AD, Exchange, GPO, registre Windows, déploiement réseau</p></div><div class="comp-detail"><strong>B2.4 — Exploiter une solution d\'infrastructure</strong><p>✓ Déploiement production, monitoring, escalade N2, support post-lancement</p></div></div></div>', color: 'linear-gradient(135deg, #1a2a4e 0%, #0f1529 100%)' },
    { title: 'Veille Technologique — Zero Trust', subtitle: 'ZTA / ZTNA : le modele de securite sans confiance implicite', content: `<div class="slide-veille-zt" style="display:flex;flex-direction:column;gap:14px"><div style="background:rgba(139,92,246,0.10);border-left:4px solid #8b5cf6;border-radius:8px;padding:14px 18px"><strong style="color:#a78bfa">Methodologie de veille</strong><p style="margin-top:8px;color:#e0e0e0">Flux RSS, bulletins <strong style="color:#fff">ANSSI</strong>, et la reference <strong style="color:#fff">NIST SP 800-207</strong> publiee par le National Institute of Standards and Technology sur le Zero Trust Architecture.</p></div><div style="display:flex;gap:14px;flex-wrap:wrap"><div style="flex:1;min-width:200px;background:rgba(239,68,68,0.08);border-left:4px solid #ef4444;border-radius:8px;padding:14px 18px"><strong style="color:#f87171">VPN traditionnel</strong><p style="margin-top:8px;color:#e0e0e0;font-size:0.92rem">Une fois connecte au tunnel, l&rsquo;utilisateur acces a <strong style="color:#fff">l&rsquo;ensemble du reseau interne</strong>.<br><br>Le modele &laquo; chateau fort avec fosse &raquo; : a l&rsquo;interieur, tout est de confiance.</p></div><div style="flex:1;min-width:200px;background:rgba(39,201,63,0.08);border-left:4px solid #27c93f;border-radius:8px;padding:14px 18px"><strong style="color:#27c93f">ZTNA &mdash; Zero Trust Network Access</strong><p style="margin-top:8px;color:#e0e0e0;font-size:0.92rem">Acces accorde <strong style="color:#fff">uniquement a l&rsquo;application specifique</strong>, apres verification continue de l&rsquo;identite et de la conformite posturale : le poste est-il a jour ? est-il chiffre ?</p></div></div><div style="background:rgba(77,159,255,0.10);border-left:4px solid #4d9fff;border-radius:8px;padding:14px 18px"><strong style="color:#4d9fff">Le lien direct avec mon projet</strong><p style="margin-top:8px;color:#e0e0e0">Mon onboarding est la <strong style="color:#fff">premiere brique de la gestion d&rsquo;identite</strong>. On s&rsquo;assure que l&rsquo;utilisateur est identifie, informe, et reconnu par le SI des son premier jour &mdash; ce qui est le <strong style="color:#fff">point d&rsquo;entree de toute strategie Zero Trust</strong>.</p></div></div>`, color: 'linear-gradient(135deg, #1a0a2e 0%, #2e1a4e 100%)' },
    { title: 'Conclusion', subtitle: 'Un projet en conditions reelles', content: '<div class="slide-conclusion-final"><div class="conclusion-box"><h4>✓ Projet réel en conditions de production</h4><p>900+ agents impactés tous secteurs confondus, déploiement effectif, retour positif RH &amp; Direction Numérique</p></div><div class="conclusion-box"><h4>✓ Compétences SISR mises en pratique</h4><p>Administration systèmes (AD/Exchange/GPO), automatisation (PowerShell), rigueur projet (audit → conception → test → déploiement)</p></div><div class="conclusion-box"><h4>✓ Résultat concret et visible</h4><p>Zéro oubli d\'envoi de la charte informatique, intégration passée de 48h à 6h, processus entièrement automatisé</p></div></div>', color: 'linear-gradient(135deg, #1a2a4e 0%, #0f1529 100%)' }
];
